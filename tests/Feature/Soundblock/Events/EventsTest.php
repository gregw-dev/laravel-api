...
use App\Events\User\NotifyUser;
use App\Helpers\Util;
use App\Models\Soundblock\Event as SoundBlockEvent;
...
class EventsTest extends TestCase {
    ...
    public function setUp(): void {
        ...
        $this->events = $this->user->soundblockEvents()->createMany(SoundBlockEvent::factory()->count(20)->make([
    ...
    public function testUserNotificationIsFired(){
//        Event::fake([
//            NotifyUser::class,
//        ]);
