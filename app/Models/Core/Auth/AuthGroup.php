...
class AuthGroup extends BaseModel {
    ...
    protected $hidden = [
        ...
        "pivot", "auth_id", BaseModel::CREATED_AT, BaseModel::UPDATED_AT,BaseModel::STAMP_CREATED,BaseModel::STAMP_CREATED_BY,BaseModel::STAMP_UPDATED_BY,BaseModel::STAMP_UPDATED
    ];
    ...
    public function permissions() {
        return $this->belongsToMany(AuthPermission::class, "core_auth_permissions_groups", "group_id", "permission_id", "group_id", "permission_id")
                     ...
                     ->withTimestamps(BaseModel::CREATED_AT, BaseModel::UPDATED_AT)
            ->select([
                "core_auth_permissions.permission_uuid", "core_auth_permissions.auth_uuid", "permission_name","core_auth_permissions.permission_memo", "core_auth_permissions_groups.permission_value", "core_auth_permissions.flag_critical" ]);
    }
    ...
    public function scopeSuperuser(Builder $builder) {
        return $builder->where("group_name", "Arena.Superusers");
    }
}
