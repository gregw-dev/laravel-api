...
class Deployment extends BaseModel {
    ...
    protected $hidden = [
        ...
        "remote_host", "remote_addr", "remote_agent", BaseModel::CREATED_AT, BaseModel::UPDATED_AT, BaseModel::DELETED_AT, BaseModel::STAMP_DELETED,
    ...
    public function takedown() {
        return ($this->hasOne(DeploymentTakedown::class, "deployment_id", "deployment_id"));
    }
}
