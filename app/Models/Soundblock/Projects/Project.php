...
use App\Models\Soundblock\Payments\MusicProjectPayment;
use Util;
...
class Project extends BaseModel {
    ...
    protected $hidden = [
        ...
        "remote_host", "remote_addr", "remote_agent", "fraud_score", BaseModel::CREATED_AT, BaseModel::UPDATED_AT, BaseModel::DELETED_AT, BaseModel::STAMP_DELETED, BaseModel::STAMP_DELETED_BY,
    ];

    protected $appends = ["artwork"];

    protected $casts = [
        "flag_music_permanent" => "boolean",
    ...
    public function getArtworkAttribute() {
        if ($this->project_artwork_rand) {
            return (cloud_url("soundblock") . Soundblock::project_artwork_path($this, $this->project_artwork_rand));
        } else {
            return (cloud_url("soundblock") . Soundblock::default_project_artwork_path());
        }
    }
    ...
    public function paymentsReport(){
        return ($this->hasMany(MusicProjectPayment::class, "project_id", "project_id"));
    }
}
