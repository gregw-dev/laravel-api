...
use App\Models\Soundblock\ArtistPublisher;
use App\Models\Soundblock\Contributor;
...
class Track extends BaseModel {
    ...
    protected $hidden = [
        "track_id", "file_id", "genre_primary_id", "genre_secondary_id", "track_language_metadata_id", "track_language_audio_id",
    ...
    public function contributors(){
        return ($this->belongsToMany(Contributor::class, "soundblock_tracks_contributors", "track_id", "contributor_id", "track_id", "contributor_id")
            ->whereNull("soundblock_tracks_contributors." . BaseModel::STAMP_DELETED)
            ->select("soundblock_contributors.contributor_name", "soundblock_tracks_contributors.contributor_role_uuid", "soundblock_contributors.contributor_uuid")
        );
    }
    ...
    public function languageMetadata(){
        return ($this->hasOne(Language::class, "data_id", "track_language_metadata_id"));
    }

    public function languageAudio(){
        return ($this->hasOne(Language::class, "data_id", "track_language_audio_id"));
    }
