...
class Postal {
    ...
    public function create(array $arrParams, User $objUser = null) {
        ...
        $arrPostal["postal_street_additional"] = $arrParams["postal_street_additional"] ?? null;
        $arrPostal["postal_city"] = $arrParams["postal_city"] ?? null;
        $arrPostal["postal_state"] = $arrParams["postal_state"] ?? null;
    ...
    public function update(UserContactPostal $objPostal, User $objUser, array $arrParams): UserContactPostal {
        ...
        if (isset($arrParams["postal_street_additional"])) {
            $arrPostal["postal_street_additional"] = $arrParams["postal_street_additional"];
        }
        ...
        if (isset($arrParams["postal_state"])) {
            $arrPostal["postal_state"] = Util::ucfLabel($arrParams["postal_state"]);
        }
