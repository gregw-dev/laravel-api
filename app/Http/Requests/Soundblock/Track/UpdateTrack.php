...
use App\Rules\Soundblock\Collection\UpdateMusicContributors;
...
class UpdateTrack extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "track_isrc"                    => "sometimes|alpha_dash|min:12|max:15",
            ...
            "track_language_metadata"       => "sometimes|string|exists:soundblock_data_languages,data_uuid",
            "track_language_audio"          => "sometimes|nullable|string|max:255",
            ...
            "genre_secondary"               => "sometimes|nullable|exists:soundblock_data_genres,data_uuid",
            ...
            "contributors.*.types.*"        => "required_with:contributors|string|exists:soundblock_data_contributors,data_uuid",
            "contributors.*.contributor"    => ["required_with:contributors", "string", "exists:soundblock_contributors,contributor_uuid", new UpdateMusicContributors($this->all())],
