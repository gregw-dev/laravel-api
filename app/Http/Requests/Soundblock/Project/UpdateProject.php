...
use App\Rules\Soundblock\Project\UpcCode;
...
class UpdateProject extends FormRequest {
    ...
    public function rules() {
        return [
            ...
            "date"                       => "sometimes|date",
            "date_release_pre"           => "sometimes|nullable|date",
            "artwork"                    => "sometimes|image|dimensions:min_width=1400,min_height=1400,max_width=8000,max_height=8000|dimensions:ratio=1/1",
            ...
            "upc"                        => ["sometimes", "nullable", "numeric", new UpcCode(), "unique:soundblock_projects,project_upc"],
...
//            "project_artist"             => "sometimes|string|max:255",
            ...
            "genre_primary"              => "sometimes|uuid|exists:soundblock_data_genres,data_uuid",
