...
use App\Rules\Soundblock\Project\ProjectDates;
...
class CreateProject extends FormRequest {
    ...
    public function rules() {
        return [
            ...
            "date_release_pre"           => ["sometimes", "nullable", "date", new ProjectDates($this->all())],
            ...
            "project_upc"                => ["sometimes", "nullable", "numeric", new UpcCode(), "unique:soundblock_projects,project_upc"],
