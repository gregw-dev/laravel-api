...
use App\Rules\Soundblock\Collection\FileThrowException;
use App\Rules\Soundblock\Collection\UploadMusicContributors;
use App\Rules\Soundblock\Collection\TrackVolumeNumber;
use App\Rules\Soundblock\Collection\TrackReleaseDate;
...
class ConfirmMultipleFiles extends FormRequest {
    ...
    public function rules() {
        return ([
            ...
            "files.*.file_title"                    => ["required_if:files.*.is_zip,0", "string", new FileThrowException()],
            ...
            "files.*.track_isrc"                    => "sometimes|alpha_dash|min:12|max:15|unique:soundblock_tracks,track_isrc",
            ...
            "files.*.track_language_metadata"       => "sometimes|nullable|string|exists:soundblock_data_languages,data_uuid",
            "files.*.track_language_audio"          => ["required_if:files.*.file_category,music", "string", "max:255", "exists:soundblock_data_languages,data_uuid"],
            "files.*.track_volume_number"           => ["required_if:files.*.file_category,music", "integer", "min:1", new TrackVolumeNumber($this->all())],
            "files.*.track_release_date"            => ["required_if:files.*.file_category,music", "date", new TrackReleaseDate($this->all())],
            ...
            "files.*.contributors.*.types.*"        => ["required_if:files.*.file_category,music", "uuid", "exists:soundblock_data_contributors,data_uuid"],
            "files.*.contributors.*.contributor"    => ["required_if:files.*.file_category,music", "uuid", "exists:soundblock_contributors,contributor_uuid", new UploadMusicContributors($this->all())],
            ...
            "files.*.genre_secondary"               => "sometimes|nullable|string|exists:soundblock_data_genres,data_uuid",
            ...
            "files.*.zip_content.*.track_isrc"                    => "sometimes|alpha_dash|min:12|max:15|unique:soundblock_tracks,track_isrc",
            ...
            "files.*.zip_content.*.track_language_metadata"       => "sometimes|nullable|string|exists:soundblock_data_languages,data_uuid",
            "files.*.zip_content.*.track_language_audio"          => "required_if:files.*.zip_content.*.file_category,music|string|max:255|exists:soundblock_data_languages,data_uuid",
            ...
            "files.*.zip_content.*.track_release_date"            => ["required_if:files.*.zip_content.*.file_category,music", "date", new TrackReleaseDate($this->all())],
            ...
            "files.*.zip_content.*.contributors.*.types.*"        => ["required_if:files.*.zip_content.*.file_category,music", "uuid", "exists:soundblock_data_contributors,data_uuid"],
            "files.*.zip_content.*.contributors.*.contributor"    => ["required_if:files.*.zip_content.*.file_category,music", "uuid", "exists:soundblock_contributors,contributor_uuid", new UploadMusicContributors($this->all())],
            ...
            "files.*.zip_content.*.genre_secondary"               => "sometimes|nullable|string|exists:soundblock_data_genres,data_uuid",
        ]);
    }
}
