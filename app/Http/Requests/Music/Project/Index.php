...
class Index extends FormRequest {
    ...
    public function rules() {
        return [
            ...
            "genres.*"             => "required_with:genres|uuid|exists:music_artists_genres,genre_uuid",
            "moods"                => "sometimes|required|array",
            "moods.*"              => "required_with:genres|uuid|exists:music_artists_moods,mood_uuid",
            "themes"               => "sometimes|required|array",
            "themes.*"             => "required_with:genres|uuid|exists:music_artists_themes,theme_uuid",
            "styles"               => "sometimes|required|array",
            "styles.*"             => "required_with:genres|uuid|exists:music_artists_styles,style_uuid",
