...
class Update extends FormRequest {
    ...
    public function rules() {
        return [
            ...
            "flag_office_hide"       => ["sometimes", "string", new FlagHideRule],
            "flag_office_complete"   => "sometimes|boolean",
            "flag_dead"              => "sometimes|boolean",
            "artist"                 => "sometimes||uuid|exists:music_artists,artist_uuid",
