...
class Artists extends Controller {
    ...
    public function create(Create $objRequest) {
        ...
        $arrData = array_merge([
            ...
            "artist_name", "active_date", "born", "allmusic_url", "amazon_url", "itunes_url", "lastfm_url", "spotify_url",
            "wikipedia_url", "genres", "styles", "themes", "moods", "members",
        ]));
        $objArtist = $this->artistsService->create($arrData);
    ...
    public function update(Update $objRequest, string $artist){
        ...
        return $this->apiReply($objArtist, "Artist data updated successfully", 200);
    }
}
