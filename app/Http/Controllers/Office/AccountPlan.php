...
class AccountPlan extends Controller
{
    ...
    public function indexTypes() {
        ...
        $objPlansTypes = $this->accountPlan->getActualPlansTypes();

        return ($this->apiReply($objPlansTypes, "", Response::HTTP_OK));
    }
    ...
    public function changeAccountPlanType(ChangeAccountPlan $objRequest, string $user_uuid, string $account){
        ...
        $objAccount = $this->accountPlan->update($objAccount, $objPlanType, $objOldPlan);
