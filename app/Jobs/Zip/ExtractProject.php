...
class ExtractProject implements ShouldQueue {
     ...
     */
    public function __construct(QueueJob $queueJob, string $fileName, array $files, string $strComment, Project $project, array $arrUserMeta) {
    ...
    public function handle(Zip $zipService, QueueJobService $qjService, Alias $aliasService) {
        ...
        try {
            ...
            $project = $zipService->unzipProject($this->fileName, $this->files, $this->strComment, $this->project, $user, $this->arrUserMeta);
