                           ...
                           AllMusicUpdateTracksTables $allMusicUpdateTracksTables, UploadPageToCloud $uploadPageToCloud)
    {
        ...
        while (true) {
            ...
            curl_setopt_array($objCurl, [
                ...
                CURLOPT_POSTFIELDS => "filters%5B%5D=releaseyear%3E%3A2018&filters%5B%5D=releaseyear%3C%3A2020&filters%5B%5D=genreid%3A" . $genreIds[$allmusicGenre] . "&sort=",
            ...
            foreach ($html->find("tbody>tr") as $dumpKey => $tr){
                ...
                if (count($tr->find(".artist>a")) > 1) {
                    ...
                    try {
                        ...
                        info($e->getMessage());
                        info( "Error!: " . $e->getMessage() . ". GetDataFromAllmusic: Line - 96");
                    }
                }
            }
