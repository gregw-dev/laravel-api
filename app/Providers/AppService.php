...
use App\Services\{Core\Arena,
    ...
    Soundblock\Contributor\Contributor as ContributorService,
...
use App\Contracts\{Auth\Auth as AuthContract,
    ...
    Soundblock\Contributor\Contributor as ContributorContract,
    ...
    public function register() {
        ...
        $this->app->bind(AccountingContract::class, function () {
            return new Accounting(
                ...
                resolve(AccountTransactionRepository::class)
            );
        });
        ...
        $this->app->bind(ContributorContract::class, ContributorService::class);
