...
class Wipe extends Command {
    ...
    const SKIP_TABLES = [
        ...
        "soundblock_data_codes_upc", "soundblock_data_contributors", "soundblock_data_exchange_rates", "soundblock_data_genres",
        "soundblock_data_languages", "soundblock_data_plans_types", "soundblock_data_projects_formats", "soundblock_data_projects_roles"
    ];
    ...
    public function handle() {
        ...
        $arrUploadedArtworkFiles = $objSbs3Driver->files("public/upload/artwork");
