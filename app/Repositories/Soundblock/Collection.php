...
use App\Repositories\Soundblock\Data\Contributors as ContributorsRolesRepository;
use Auth;
...
class Collection extends BaseRepository
{
     ...
     */
    public function __construct(CollectionModel $objCol, ContributorsRolesRepository $contributorsRolesRepo) {
        $this->model = $objCol;
    ...
    public function getOrderedTracks(CollectionModel $collection) {
        return File::join("soundblock_collections_files", function ($join) use ($collection) {
            ...
            ->orderBy("soundblock_tracks.track_volume_number", "asc")
    ...
    public function getCollectionOrderedTracks(CollectionModel $objCollection) {
        ...
        $objCollection->files->map(function ($item){
            ...
            $objContributors = $item->track->contributors;
            ...
            if (!empty($objContributors)) {
                ...
                unset($item->track->contributors);
                $item->track->contributors = $arrContributors;
            }
