...
class ProjectsBandwidth extends BaseRepository {
    ...
    public function storeAccountBandwidth(AccountModel $objAccount, User $objUser, int $intFileSize, string $flagAction){
    ...
    public function getTransferSizeByAccountAndDates(AccountModel $objAccount, string $dateStart, string $dateEnd){
        return (
            $this->model->where("account_id", $objAccount->account_id)
