...
//                "App.Soundblock.Project.Member.Delete",
    ...
    "support" => [
        ...
        "flag_status"    => [
            "Open", "Closed", "Awaiting User", "Awaiting Support", "Awaiting Customer", "All"
        ],
        "message_status" => [
            "Read", "Unread",
        ],
        "apps_types_permissions" => [
            "apparel" => "Arena.Support.Merchandising",
            "catalog" => "Arena.Support.Merchandising",
            "merchandising" => "Arena.Support.Merchandising",
            "embroidery" => "Arena.Support.Merchandising",
            "facecoverings" => "Arena.Support.Merchandising",
            "prints" => "Arena.Support.Merchandising",
            "screenburning" => "Arena.Support.Merchandising",
            "sewing" => "Arena.Support.Merchandising",
            "tourmask" => "Arena.Support.Merchandising",
            "soundblock" => "Arena.Support.Soundblock",
            "soundblock.web" => "Arena.Support.Soundblock",
            "music" => "Arena.Support.Music",

            //incorrect
            "arena" => "Arena.Support.Merchandising",
            "io" => "Arena.Support.Merchandising",
            "office" => "Arena.Support.Merchandising",
            "account" => "Arena.Support.Merchandising",
            "ux" => "Arena.Support.Merchandising"
        ]
    ],
