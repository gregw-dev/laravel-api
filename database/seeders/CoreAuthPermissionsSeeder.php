...
class CoreAuthPermissionsSeeder extends Seeder {
    ...
    public function run() {
        ...
        $arrSoundPermissions = [
            ...
            "App.Soundblock.Account.Artist.Create", "App.Soundblock.Account.Artist.Update",
            "App.Soundblock.Account.Artist.Delete", "App.Soundblock.Account.Contributor.Create",
            "App.Soundblock.Account.Contributor.Update", "App.Soundblock.Account.Contributor.Delete",
