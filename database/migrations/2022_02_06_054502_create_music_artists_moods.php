...
class CreateMusicArtistsMoods extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('music_artists_moods', function (Blueprint $objTable) {
            ...
            $objTable->string("artist_mood")->index("idx_artist-mood");
            ...
            $objTable->unique(["artist_id","artist_mood","stamp_source"],"uidx_artist-id_artist-mood_stamp-source");
        });
    }
    ...
    {
        Schema::dropIfExists('music_artists_moods');
    }
}
