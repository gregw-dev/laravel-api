...
class CreateMusicArtistsSimilar extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('music_artists_similar', function (Blueprint $objTable) {
            ...
            $objTable->string("artist_similar")->index("idx_artist-similar");
            ...
            $objTable->unique(["artist_id","artist_similar","stamp_source"],"uidx_artist-id_artist-similar_stamp-source");
        });
    }
    ...
    {
        Schema::dropIfExists('music_artists_similar');
    }
}
