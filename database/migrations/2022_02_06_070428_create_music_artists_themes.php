...
class CreateMusicArtistsThemes extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('music_artists_themes', function (Blueprint $objTable) {
            ...
            $objTable->string("artist_theme")->index("idx_artist-theme");
            ...
            $objTable->unique(["artist_id","artist_theme","stamp_source"],"uidx_artist-id_artist-theme_stamp-source");
        });
    }
    ...
    {
        Schema::dropIfExists('music_artists_themes');
    }
}
