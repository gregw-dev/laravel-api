...
class CreateMusicArtistsMembers extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('music_artists_members', function (Blueprint $objTable) {
            ...
            $objTable->string("artist_member")->index("idx_artist-member");
            ...
            $objTable->unique(["artist_id","artist_member","stamp_source"],"uidx_artist-id_artist-member_stamp-source");
        });
    }
    ...
    {
        Schema::dropIfExists('music_artists_members');
    }
}
