...
class CreateMusicProjectsTracksPerformersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('music_projects_tracks_performers', function (Blueprint $objTable) {
            $objTable->bigIncrements('performer_id')->index("idx_performer-id")->unique("uidx_performer-id");
            $objTable->uuid('performer_uuid')->index("idx_performer-uuid")->unique("uidx_performer-uuid");
    ...
    {
        Schema::dropIfExists('music_projects_tracks_performers');
    }
}
