...
class CreateMusicProjectsThemesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('music_projects_themes', function (Blueprint $objTable) {
            ...
            $objTable->string("project_theme")->index("idx_project-theme");
            ...
            $objTable->unique(["project_id","project_theme"],"uidx_project-id_project-theme");
            $objTable->unique(["project_uuid","project_theme"],"uidx_project-uuid_project-theme");
        });
    }
    ...
    {
        Schema::dropIfExists('music_projects_themes');
    }
}
