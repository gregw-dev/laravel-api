...
class CreateMusicMapsTracksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create("music_maps_tracks", function (Blueprint $objTable) {
            ...
            $objTable->index(["artist_uuid", "project_uuid", "track_uuid"], "idx_artist-uuid_project-uuid_track-uuid");
            $objTable->index(["artist_name", "project_name", "track_name"], "idx_artist-name_project-name_track-name");
            $objTable->index(["artist_uuid", "project_uuid", "track_name"], "idx_artist-uuid_project-uuid_track-name");
        });
    }
    ...
    {
        Schema::dropIfExists("music_maps_tracks");
    }
}
