...
class CreateMusicArtistsStyles extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('music_artists_styles', function (Blueprint $objTable) {
            ...
            $objTable->string("artist_style")->index("idx_artist-style");
            ...
            $objTable->enum("flag_status",["EXACT","HOLD","MANUAL","UNKNOWN",""])->default("EXACT");
            ...
            $objTable->unique(["artist_id","artist_style","stamp_source"],"uidx_artist-id_artist-style_stamp-source");
        });
    }
    ...
    {
        Schema::dropIfExists('music_artists_styles');
    }
}
