...
class CreateMusicProjectsStylesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('music_projects_styles', function (Blueprint $objTable) {
            ...
            $objTable->string("project_style")->index("idx_project-style");
            ...
            $objTable->unique(["project_id","project_style"],"uidx_project-id_project-style");
            $objTable->unique(["project_uuid","project_style"],"uidx_project-uuid_project-style");
        });
    }
    ...
    {
        Schema::dropIfExists('music_projects_styles');
    }
}
