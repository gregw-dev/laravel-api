...
@section("content")
    <div class="container-fluid vh-100">
        <div class="row align-items-center justify-content-center h-100" style="background-color: #1b212e;">
            <div class="col-md-5 col-lg-5 col-xl-4">
                ...
                <div class="alert alert-danger mt-3">
                    <h2><strong>Access Denied:</strong> You do not have permission to view the asset you are trying to access.</h2>
            </div>
